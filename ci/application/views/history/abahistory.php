...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
	<h4>Abandoned Sessions For <?php echo $this->uri->segment(3); ?></h4>
	<div id="historylinks">
	    ...
	    <?php echo anchor('studenthistory_controller/aba_history/' . $this->uri->segment(3) . '', 'Abandoned', 'id="currenthistory"'); ?>
	...
	<table id='datatables' class='display'>
		...
		foreach ($history as $row) {
    		...
    		<tr>
    		    ...
    		    <td><?php echo htmlspecialchars($row['abandonreason'], ENT_QUOTES, 'UTF-8') ?></td>
