...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
	<h4>Terminated Sessions For <?php echo $this->uri->segment(3); ?></h4>
	<div id="historylinks">
	    ...
	    <?php echo anchor('studenthistory_controller/term_history/' . $this->uri->segment(3) . '', 'Terminated', 'id="currenthistory"'); ?>
	...
	<table id='datatables' class='display'>
		...
		foreach ($history as $row) {
    		...
    		<tr>
    		    ...
    		    <td><?php echo htmlspecialchars($row['terminationreason'], ENT_QUOTES, 'UTF-8') ?></td>
