<div id="abandon_form">
	...
	<fieldset><legend>Name</legend>
	    ...
	    echo form_open('studentqueue_controller/abandon/' . urlencode($this->uri->segment(3)) . '');
	    echo form_input('fname', set_value('fname'), $fname);
	    echo form_input('lname', set_value('lname'), $lname);
	    ?>
	</fieldset>
	<fieldset><legend>Reason For Abandoning Session</legend>
	    <textarea name="abandoncomments" rows="5" cols="38" placeholder="Comments"><?php echo set_value('terminationcomments') ?></textarea>
