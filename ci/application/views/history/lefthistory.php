...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
	<h4>Left Sessions For <?php echo $this->uri->segment(3); ?></h4>
	<div id="historylinks">
	    ...
	    <?php echo anchor('studenthistory_controller/left_history/' . $this->uri->segment(3) . '', 'Left', 'id="currenthistory"'); ?>
	    ...
	    <?php echo anchor('studenthistory_controller/forms_history/' . $this->uri->segment(3) . '', 'Forms'); ?>
	</div>
	<table id='datatables' class='display'>
		...
		foreach ($history as $row) {
    		...
    		<tr>
    		    ...
    		    <td><?php echo htmlspecialchars($row['reasons'], ENT_QUOTES, 'UTF-8') ?></td>
    		    <td><?php echo htmlspecialchars($row['comments'], ENT_QUOTES, 'UTF-8') ?></td>
