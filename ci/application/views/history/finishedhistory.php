...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
	<h4>All Finished Sessions For <?php echo $this->uri->segment(3); ?></h4>
	<div id="historylinks">
	    <?php echo anchor('studenthistory_controller/history/' . $this->uri->segment(3) . '', 'All'); ?>
	    <?php echo anchor('studenthistory_controller/fin_history/' . $this->uri->segment(3) . '', 'Finished', 'id="currenthistory"'); ?>
